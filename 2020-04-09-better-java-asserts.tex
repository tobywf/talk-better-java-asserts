...
\begin{frame}[fragile]{JUnit vs AssertJ}
JUnit:
\begin{minted}{java}
...
\begin{frame}{JUnit vs AssertJ}
\begin{itemize}
\item obvious argument order
\item strongly typed; can't accidentally compare incompatible types
\item AssertJ matchers are very powerful, and you can write your own
...
\item prefer AssertJ over Hamcrest, because auto-complete makes discovering matchers easy, less nesting due to fluent style
\end{itemize}
\end{frame}
